...
public class Disable extends AbstractAnomalyCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (this.upgraded) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, p, new DisablePower(m, this.magicNumber), this.magicNumber));
        } else {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, p, new DisablePower(m, 1), 1));
        }
    }
