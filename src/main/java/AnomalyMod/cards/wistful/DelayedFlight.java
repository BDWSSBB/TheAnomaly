...
import AnomalyMod.powers.DelayedFlightPower;
...
public class DelayedFlight extends AbstractAnomalyCard {
    ...
    public static final String ID = "anomalyMod:DelayedFlight";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "AnomalyModResources/cards/wistful/delayedFlight.png";
