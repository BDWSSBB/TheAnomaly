...
public class BlastPipe extends AbstractAnomalyCard {

    public static final String ID = "anomalyMod:BlastPipe";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "AnomalyModResources/cards/wistful/blastPipe.png";
