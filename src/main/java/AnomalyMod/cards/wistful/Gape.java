...
import AnomalyMod.actions.unique.GapeAction;
...
public class Gape extends AbstractAnomalyCard {

    public static final String ID = "anomalyMod:Gape";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "AnomalyModResources/cards/wistful/gape.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new GapeAction(m, this.magicNumber));
    }
