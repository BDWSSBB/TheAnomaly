...
public class ControlHijack extends AbstractAnomalyRelic {
    ...
    public ControlHijack() {
        ...
        this.tips.add(new PowerTip(DESCRIPTIONS[2], FontHelper.colorString(new ImprobabilityDrivePortableTerminalInfo().name, "y") + DESCRIPTIONS[3] + CONTROL_HIJACK_IMPROBABILITY_LOSS + DESCRIPTIONS[4]));
    ...
    public String getUpdatedDescription() {
        return DESCRIPTIONS[0] + FontHelper.colorString(new ImprobabilityDrivePortableTerminalInfo().name, "y") + DESCRIPTIONS[1];
    }
