...
public class ImBetterThanHeavyBladePatch {
        ...
        public static ExprEditor Instrument() {
            return new ExprEditor() {
                ...
                public void edit(MethodCall m) throws CannotCompileException {
                    if (m.getMethodName().equals("atDamageGive")) {
                        m.replace(
                                "{" +
    ...
    public static class atDamageReceiveCalculateCardDamageHook {
    ...
    public static class atDamageFinalGiveCalculateCardDamageHook {
