...
public class NeuralCablesQuest extends AbstractImageEvent {

    public static final String ID = "anomalyMod:NeuralCablesQuest";
        ...
        switch (this.screen) {
            case INTRO: {
                switch (buttonPressed) {
                    case 0: {
                        AnomalyModDungeonData.neuralCables = AnomalyModDungeonData.QuestComponentQuality.NORMAL;
                    ...
                    case 1: {
                        ...
                        AnomalyModDungeonData.neuralCables = AnomalyModDungeonData.QuestComponentQuality.PERFECT;
