...
public class DataDecoderQuest extends AbstractImageEvent {

    public static final String ID = "anomalyMod:DataDecoderQuest";
        ...
        switch (this.screen) {
            case INTRO: {
                switch (buttonPressed) {
                    case 0: {
                        AnomalyModDungeonData.dataDecoder = AnomalyModDungeonData.QuestComponentQuality.NORMAL;
                    ...
                    case 1: {
                        ...
                        AnomalyModDungeonData.dataDecoder = AnomalyModDungeonData.QuestComponentQuality.PERFECT;
