...
public class PhaseControllerChipQuest extends AbstractImageEvent {

    public static final String ID = "anomalyMod:PhaseControllerChipQuest";
    ...
    public PhaseControllerChipQuest() {
        ...
        switch (this.screen) {
            case INTRO: {
                switch (buttonPressed) {
                    case 0: {
                        AnomalyModDungeonData.phaseControllerChip = AnomalyModDungeonData.QuestComponentQuality.NORMAL;
                    ...
                    case 1: {
                        ...
                        AnomalyModDungeonData.phaseControllerChip = AnomalyModDungeonData.QuestComponentQuality.PERFECT;
